...
var ASM_CONSTS = {
 ...
 90614: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 90697: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 90766: () => { return window.innerWidth; },  
 90796: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
