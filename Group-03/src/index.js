...
var ASM_CONSTS = {
 ...
 155174: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 155257: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 155326: () => { return window.innerWidth; },  
 155356: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
