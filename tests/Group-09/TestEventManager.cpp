...
TEST_CASE("Pause EventManager event - valid", "[EventManager]")
{
  ...
  Event<int> e1 = eM.AddEvent(1, printEvent, 1).value();
  Event<int> e2 = eM.AddEvent(3, printEvent, 2).value();
  Event<int> e3 = eM.AddEvent(3, printEvent, 3).value();
  Event<int> e4 = eM.AddEvent(3, printEvent, 4).value();
  std::set<int> runningEvents;
  runningEvents.insert(0);
  runningEvents.insert(1);
  runningEvents.insert(2);
...
TEST_CASE("Resume EventManager event", "[EventManager]")
{
  ...
  Event<int> e1 = eM.AddEvent(1, printEvent, 1).value();
  Event<int> e2 = eM.AddEvent(3, printEvent, 2).value();
  Event<int> e3 = eM.AddEvent(1202, printEvent, 3).value();
  Event<int> e4 = eM.AddEvent(3, printEvent, 4).value();
  Event<int> e5 = eM.AddEvent(5, printEvent, 5).value();
...
TEST_CASE("Trigger events", "[EventManager]")
{
  ...
  eM.AddEvent(3, printEvent, 2);
  eM.AddEvent(5, printEvent, 3);
...
{
  EventManager<int> eM;
  std::optional<Event<int>> e1 = eM.AddEvent(1, printEvent, 1);
  CHECK(e1.has_value());
  std::optional<Event<int>> e2 = eM.AddEvent(3, printEvent, 2);
  CHECK(e2.has_value());
