...
//     std::vector<cse::Vertex const *> expectedPath = {&v1, &v2, &v3, &v4};
...
//   //     ++pos;
//   //     CHECK(pos.GetCurrentVertex() == v2); // BFS visits all direct
//   neighbors
//   //     first
//   //     ++pos;
//   //     CHECK(pos.GetCurrentVertex() == v3);
...
//   //     CHECK((firstMove == v2 || firstMove == v3)); // Could be either B or
//   C
//   // }
// }
