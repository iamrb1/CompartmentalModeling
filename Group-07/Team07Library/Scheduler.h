...
{
    /*
     * Priority queue to schedule processes to run based on how often each process is used
     */
    class Scheduler
    {
    private:
        /// Maps each process ID to the number of times that the process is currently in the scheduler
        std::map<int, int> scheduleMap;

        /// Maps each process ID to the number of times that process has been added to the scheduler
        ...
        //Code for merge and merge sort taken from https://www.geeksforgeeks.org/merge-sort/
    ...
    public:
        ...
        /**
         * Gets the ID for the highest priority process according to the scheduler, and removes it from the scheduler
