...
public:
     ...
     *
     * The log file is opened in append mode. An assertion ensures that the file is opened successfully.
     *
     ...
     *
     * The message is prefixed with the current time. Depending on the configuration,
     * the message is output to both the console and the log file.
     *
